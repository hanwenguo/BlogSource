...
export type AstroTypstConfig = {
     ...
     * @deprecated this should have no effect now, see https://github.com/OverflowCat/astro-typst/issues/21
     * but is added to bypass upstream hast output bug, see https://github.com/Myriad-Dreamin/typst.ts/issues/815
     */
    body?: boolean | "hast";
